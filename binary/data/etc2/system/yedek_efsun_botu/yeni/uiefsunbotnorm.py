...
class EigenartigSwitchBotDialog(ui.ScriptWindow):
	...
	def __del__(self):
		...
		if constInfo.normalefsunbotu:
			constInfo.normalefsunbotu = 0
		
	def AddGui(self):
		Gui = [
		[[ui.BoardWithTitleBar, ""], [495-58, 285], [0,0], [["SetCenterPosition", [""]], ["SetCloseEvent", [self.__del__]], ["SetTitleName", ["Normal Efsun Botu "]]], ["float","movable"]],			
...
##		
	...
	def __init__(self):
		...
		self.BonusIDListe = [["Seçilmedi", 0], ["Max HP.", 1], ["Max SP.", 2], ["Canlýlýk", 3], ["Zeka", 4], ["Güç", 5], ["Çeviklik", 6], ["Saldýrý Hýzý", 7], ["Hareket Hýzý", 8], ["Büyü Hýzý", 9], ["Hp Üretimi", 10], ["SP Üretimi", 11], ["Zehirleme Deðiþimi", 12], ["Kanama Saldýrýsý", 92], ["Sersemletme Þansý", 13], ["Yavaþlatma Þansý", 14], ["Kritik Vuruþ", 15], ["Delici Vuruþ", 16], ["Yarý Ýnsanlara Karþý Güçlü", 17], ["Hayvanlara Karþý Güçlü", 18], ["Orklara Karþý Güçlü", 19], ["Mistiklere Karþý Güçlü", 20], ["Ölümsüzlere Karþý Güçlü", 21], ["Þeytanlara Karþý Güçlü", 22], ["HP Absorbe", 23], ["SP Absorbe", 24], ["Beden K. Ataklarýn Blok.", 27], ["Oklardan Korunma Þansý", 28], ["Kýlýç Savunmasý", 29], ["Çift El Savunmasý", 30], ["Býçak/Pençe Savunmasý", 31], ["Çan Savunmasý", 32], ["Yelpaze Savunmasý", 33], ["Oka Karþý Dayanýklýlýk", 34], ["Ateþe Karþý Dayanýklýlýk", 35], ["Þimþeðe Karþý Dayanýklýlýk", 36], ["Büyüye K. Dayanýklýlýk", 37], ["Rüzgara K. Dayanýklýlýk", 38], ["Vücut D. Yansýtmasý", 39], ["Zehre Karþý Koyma", 41], ["Kanama Saldýrýlarýnda Direnç", 93], ["Exp-Bonus", 43], ["Ýki Kat Yang", 44], ["Ýki Kat Ýtem", 45], ["Sersemlik K. Baðýþýklýlýk", 48], ["Yavaþlama K. Baðýþýklýlýk", 49], ["Saldýrý Deðeri", 53], ["Beceri Hasarý", 71], ["Ortalama Hasar", 72], ["--------------Týlsým Efsunlarý--------------", 0], ["Kýlýç Savunmasýndan Kopuþ", 104], ["Çiftel Savunmasýndan Kopuþ", 105], ["Býçak Savunmasýndan Kopuþ", 106], ["Çan Savunmasýndan Kopuþ", 107], ["Yelpaze Savunmasýndan Kopuþ", 108], ["Ok Savunmasýndan Kopuþ", 109], ["Pençe Savunmasýndan Kopuþ", 110], ["Karanlýk Direnci", 89], ["Yarý Ýnsan Direnci", 111], ["Dünya Direnci", 88], ["Buz Direnci", 87], ["Düþüþ Direnci", 115], ["Böceklere Karþý Güçlü", 112], ["Çöl Canavarlarýna Karþý Güçlü", 113], ["Zodyak Canavarlarýna Karþý Güçlü", 114]]
	...
	def LoadBnsCfgFile(self):
		self.SavedBonus = []
		try:
			for information in open("efsunbotnorm.eig", "r").readlines():
	...
	def LoadBonusSets(self, index):
		if index ==31:
			try: os.remove("efsunbotnorm.eig")
			except: pass
