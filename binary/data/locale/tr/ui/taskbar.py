...
window = {
	...
	(
		...
		},
		{
			...
			"x" : 270,
			"y" : 3 + Y_ADD_POSITION,
			"tooltip_text" : "Deneyim Kazan??A?Kapat",

			"default_image" : "xp1.tga",
			"over_image" : "xp2.tga",
			"down_image" : "xp2.tga",
		},
		...
		{
			"name" : "DeleteSellButton",
			"type" : "button",

			"x" : SCREEN_WIDTH - 215,
			"y" : 2 + Y_ADD_POSITION,

			"tooltip_text" : uiScriptLocale.TASKBAR_DELETE_SELL,

			"default_image" : "icon/item/sat.tga",
			"over_image" : "icon/item/sat2.tga",
			"down_image" : "icon/item/sat3.tga",
		},
		{
