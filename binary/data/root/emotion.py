...
if EMOTION_VERSION == 2:
	...
	EMOTION_DICT = {
		...
		EMOTION_WEATHER_1 :		{"name": localeInfo.EMOTION_WEATHER_1,	"command":"(sun)"},
		EMOTION_WEATHER_2 :		{"name": localeInfo.EMOTION_WEATHER_2,	"command":"(rainbow)"},
		EMOTION_WEATHER_3 :		{"name": localeInfo.EMOTION_WEATHER_3,	"command":"(night)"},
		EMOTION_WHIRL :			{"name": localeInfo.EMOTION_WHIRL,		"command":"(blablabla)"},
