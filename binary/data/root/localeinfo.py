...
if 949 == app.GetDefaultCodePage():
	...
	def NumberToMoneyStringArama(number):
		if long(number) <= 0:
			return "0 |cFFc7b81fYang|r"
		number = str(number)
		...
		result = result+ "|Eemoji/money|e"
		return result
		
	def NumberToMoneyWonString(number):
		if long(number) <= 0:
			return "0 |cFFc7b81fWon|r"
		number = str(number)
		result = CutMoneyString(number, 0, 3, "", "")
		result = CutMoneyString(number, 3, 6, " |cFFc7b81fK|r", result)
		result = CutMoneyString(number, 6, 9, " |cFFc7b81fM|r", result)
