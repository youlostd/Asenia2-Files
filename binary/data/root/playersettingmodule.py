...
def DefineSkillIndexDict():
	...
	if NEW_678TH_SKILL_ENABLE:
		SKILL_INDEX_DICT = {
			JOB_WARRIOR : {1 : (1, 2, 3, 4, 5, 6, 0, 0, 137, 0, 138, 0, 139, 0,), 2 : (16, 17, 18, 19, 20, 21, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_ASSASSIN : {1 : (31, 32, 33, 34, 35, 36, 0, 0, 137, 0, 138, 0, 139, 0, 140,), 2 : (46, 47, 48, 49, 50, 51, 0, 0, 137, 0, 138, 0, 139, 0, 140,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_SURA : {1 : (61, 62, 63, 64, 65, 66, 0, 0, 137, 0, 138, 0, 139, 0,), 2 : (76, 77, 78, 79, 80, 81, 0, 0, 137, 0, 138, 0, 139, 0,),"SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_SHAMAN : {1 : (91, 92, 93, 94, 95, 96, 0, 0, 137, 0, 138, 0, 139, 0,), 2 : (106, 107, 108, 109, 110, 111, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_WOLFMAN : {1 : (170, 171, 172, 173, 174, 175, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
		}
	else:
		SKILL_INDEX_DICT = {
			JOB_WARRIOR : {1 : (1, 2, 3, 4, 5, 0, 0, 0, 137, 0, 138, 0, 139, 0,), 2 : (16, 17, 18, 19, 20, 0, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_ASSASSIN : {1 : (31, 32, 33, 34, 35, 0, 0, 0, 137, 0, 138, 0, 139, 0, 140,), 2 : (46, 47, 48, 49, 50, 0, 0, 0, 137, 0, 138, 0, 139, 0, 140,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_SURA : {1 : (61, 62, 63, 64, 65, 66, 0, 0, 137, 0, 138, 0, 139, 0,), 2 : (76, 77, 78, 79, 80, 81, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_SHAMAN : {1 : (91, 92, 93, 94, 95, 96, 0, 0, 137, 0, 138, 0, 139, 0,), 2 : (106, 107, 108, 109, 110, 111, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
			JOB_WOLFMAN : {1 : (170, 171, 172, 173, 174, 175, 0, 0, 137, 0, 138, 0, 139, 0,), "SUPPORT" : (122, 143, 144, 145, 146, 147, 148, 141, 130, 142, 149, 121),},
		}
...
def RegisterSkill(race, group, empire=0):
	...
	if app.LWT_BUFF_UPDATE:
		for i in xrange(3):
			player.SetSkill(i+245, i+245)
	if app.LWT_BUFF_UPDATE:
		for i in xrange(2):
			player.SetSkill(i+248, i+248)
...
def SetGeneralMotionsForWolfman(mode, folder):
	...
	chrmgr.RegisterCacheMotionData(mode, chr.MOTION_DAMAGE, "back_damage1.msa", 50)
...
def __InitData():
	if app.ENABLE_CPP_PSM:
		...
		# chrmgr.RegisterCacheEffect(chrmgr.EFFECT_THANOS_WHITE_EQUIP, "", "d:/ymir work/effect/thanos/buff_white.mse")
		# chrmgr.RegisterCacheEffect(chrmgr.EFFECT_THANOS_RED_EQUIP, "", "d:/ymir work/effect/thanos/buff_red.mse")
		# chrmgr.RegisterCacheEffect(chrmgr.EFFECT_THANOS_BLUE_EQUIP, "", "d:/ymir work/effect/thanos/buff_blue.mse")
		# chrmgr.RegisterCacheEffect(chrmgr.EFFECT_THANOS_YELLOW_EQUIP, "", "d:/ymir work/effect/thanos/buff_yellow.mse")
		# chrmgr.RegisterCacheEffect(chrmgr.EFFECT_THANOS_BLACK_EQUIP, "", "d:/ymir work/effect/thanos/buff_black.mse")
		# chrmgr.RegisterCacheEffect(chrmgr.EFFECT_THANOS_GREEN_EQUIP, "", "d:/ymir work/effect/thanos/buff_green.mse")
...
def __LoadGameEffect():
	if app.ENABLE_CPP_PSM:
		...
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+14, "Bip01", "d:/ymir work/effect/hit/blow_flame/flame_loop_w.mse")
		...
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+43, "Bip01", "locale/tr/common/effect/guild_leader.mse")

		
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + chr.AFFECT_STATUE1-1, "", "d:/ymir work/effect/monster2/redd_moojuk.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + chr.AFFECT_STATUE2-1, "", "d:/ymir work/effect/monster2/redd_moojuk.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + chr.AFFECT_STATUE3-1, "", "d:/ymir work/effect/monster2/redd_moojuk_blue.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + chr.AFFECT_STATUE4-1, "", "d:/ymir work/effect/monster2/redd_moojuk_green.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + chr.AFFECT_STATUE5-1, "", "d:/ymir work/effect/monster2/sari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+48,"", "d:/ymir work/pc/assassin/effect/kwaegeom_loop.mse")
		if app.OTOMATIK_AV:
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+49, "Bip01", "d:/ymir work/effect/etc/oyuncuEffect/otoAv.mse")
		if app.ENABLE_AURA_SYSTEM:
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 52, "Bip01 Spine2", "d:/ymir work/pc/common/effect/aura/aura_250_006_1.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 53, "Bip01 Spine2", "d:/ymir work/pc/common/effect/aura/aura_250_006_2.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 54, "Bip01 Spine2", "d:/ymir work/pc/common/effect/aura/aura_250_006_3.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 55, "Bip01 Spine2", "d:/ymir work/pc/common/effect/aura/aura_250_006_4.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 56, "Bip01 Spine2", "d:/ymir work/pc/common/effect/aura/aura_250_006_5.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT + 57, "Bip01 Spine1", "d:/ymir work/pc/common/effect/aura/aura_250_006_6.mse")
		...
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+19, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7_w.mse")
		...
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+29, "PART_WEAPON", "D:/ymir work/item/weapon/kozik.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+30, "PART_WEAPON_LEFT", "D:/ymir work/item/weapon/kozik.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+31, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_sonbahar_yelpazesi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+32, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_antik_can.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+33, "PART_WEAPON_LEFT", "D:/ymir work/item/weapon/jelonek.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+34, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/weapon30/claw_r.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+35, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/weapon30/claw_l.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+36, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_dolunay.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+37, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_kdp.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+38, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_seytan_kanadi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+39, "PART_WEAPON_LEFT", "D:/ymir work/item/weapon/kadim_seytan_kanadi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+40, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_orkide_can.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+41, "PART_WEAPON_LEFT", "D:/ymir work/item/weapon/kadim_havali_celik_yay.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+42, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/weapon75/claw_r.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+43, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/weapon75/claw_l.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+44, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_zehir.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+45, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_kin.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+46, "PART_WEAPON", "D:/ymir work/item/weapon/kadim_aslan_kilic.mse")
		
		
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+48, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9sari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+49, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9turuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+50, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9mavi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+51, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9mor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+52, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_bsari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+53, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_bturuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+54, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_bmavi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+55, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_bmor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+56, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_fsari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+57, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_fturuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+58, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_fmavi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+59, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_fmor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+60, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_ssari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+61, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_sturuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+62, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_smavi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+63, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_smor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+64, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_ssari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+65, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_sturuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+66, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_smavi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+67, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_smor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+68, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_wsari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+69, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_wturuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+70, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_wmavi.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+71, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_wmor.mse")

		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+72, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_wsari.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+73, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_wturuncu.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+75, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_wmor.mse")

		if app.ENABLE_KOSTUMPARLA:
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+76, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_sari.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+77, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_beyaz.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+78, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_mor.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+79, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_kirmizi.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+80, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_pembe.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+81, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_yesil.mse")
			chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+82, "Bip01", "D:/ymir work/effect/armor_6/maviruh_parlama_mavi.mse")
...
# def __LoadGameWolfmanEx(race, path):
	...
	# chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_CLAW, chr.MOTION_WAIT, "wait2.msa", 50)
...
if app.ENABLE_RACE_HEIGHT:
	def __LoadRaceHeight():
		try:
			...
			import exception
			exception.Abort("__LoadRaceHeight")
