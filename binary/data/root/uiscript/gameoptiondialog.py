...
## Auto PickUP
				...
				{"name" : "ConvertMobText","type" : "text","x" : 19,"y" : 390+2,"text" : localeInfo.TRANSFORM_MOBS,},
				{"name" : "dog_mode_open","type" : "radio_button","x" : LINE_DATA_X,"y" : 390,"text" : localeInfo.TRANSFORM_ON,
					"default_image" : ROOT_PATH + "Middle_Button_01.sub",
					"over_image" : ROOT_PATH + "Middle_Button_02.sub",
					"down_image" : ROOT_PATH + "Middle_Button_03.sub",
				},{"name" : "dog_mode_close", "type" : "radio_button", "x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH*1, "y" : 390, "text" : localeInfo.TRANSFORM_OFF,
					"default_image" : ROOT_PATH + "Middle_Button_01.sub",
					"over_image" : ROOT_PATH + "Middle_Button_02.sub",
					"down_image" : ROOT_PATH + "Middle_Button_03.sub",
				},
				{ "name" : "effGGYazi", "type" : "text", "x" : LINE_LABEL_X, "y" : 415+2,
					#"text" : "Efektler",
				},
				{"name" : "efekt_Gizle", "type" : "radio_button", "x" : LINE_DATA_X, "y" : 415,
					"text" : "Efekt Ac",
					"default_image" : ROOT_PATH + "Middle_Button_01.sub",
					"over_image" : ROOT_PATH + "Middle_Button_02.sub",
					"down_image" : ROOT_PATH + "Middle_Button_03.sub",
				},
				{ "name" : "efekt_Goster", "type" : "radio_button", "x" : LINE_DATA_X+MIDDLE_BUTTON_WIDTH*1,
					"y" : 415,
					"text" : "Efekt Gizle",
					"default_image" : ROOT_PATH + "Middle_Button_01.sub",
					"over_image" : ROOT_PATH + "Middle_Button_02.sub",
