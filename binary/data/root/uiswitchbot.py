...
class SwitchbotItemTab(ui.ThinBoardCircle):
	...
	def RefreshItemSlot(self):	
		...
		for i in xrange(switchbot.SLOT_COUNT):
			if (not switchbot.IsActive(i)):
				j += 1
				if (j == switchbot.SLOT_COUNT):
					constInfo.IsSwitchBotActive = 0
...
class SwitchbotWindow(ui.BoardWithTitleBar):
	...
	def __LoadWindow(self):
		...
		self.alternativeTextLine.SetText("Alternatif Sayfa:")
