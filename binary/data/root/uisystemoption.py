...
#		self.ctrlShadowQuality.SetEvent(ui.__mem_func__(self.OnChangeShadowQuality))
		...
		if app.ENABLE_ENVIRONMENT_EFFECT_OPTION:
			...
			self.__ClickRadioButton(self.NightModeOption, not systemSetting.GetNightModeOption())
			self.__ClickRadioButton(self.SnowModeOption, not systemSetting.GetSnowModeOption())
			self.__ClickRadioButton(self.SnowTextureModeOption, not systemSetting.GetSnowTextureModeOption())
