...
class ExpandedMoneyTaskBar(ui.ScriptWindow):
	...
	def RefreshStatus(self):
		gaya1 = player.GetItemCountByStoneVnum(50926)
		gaya2 = player.GetItemCountByVnum(50926)
		gaya3 = player.GetItemCountByStoneVnum(50927)
		gaya4 = player.GetItemCountByVnum(50927)
		self.money.SetText(localeInfo.NumberToMoneyString2(player.GetElk()))
		self.cheque.SetText(localeInfo.NumberToMoneyString2(player.GetWon()))
		self.Gem.SetText(localeInfo.NumberToMoneyString2(gaya1+gaya2))
		self.RedGem.SetText(localeInfo.NumberToMoneyString2(gaya3+gaya4))
...
class TaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		toggleButtonDict[TaskBar.BUTTON_EXP]=self.GetChild("ExpButton")
		toggleButtonDict[TaskBar.BUTTON_DELETE_SELL]=self.GetChild("DeleteSellButton")
