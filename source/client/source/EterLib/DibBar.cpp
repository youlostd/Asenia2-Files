...
{
	RECT rect = {static_cast<int>(0), static_cast<int>(0), static_cast<int>(m_dwWidth), static_cast<int>(m_dwHeight)};
...
CBlockTexture * CDibBar::__BuildTextureBlock(DWORD dwxPos, DWORD dwyPos, DWORD dwImageWidth, DWORD dwImageHeight, DWORD dwTextureWidth, DWORD dwTextureHeight)
{
	...
	RECT posRect = {static_cast<int>(dwxPos), static_cast<int>(dwyPos), static_cast<int>(dwxPos + dwImageWidth), static_cast<int>(dwyPos + dwImageHeight)};
