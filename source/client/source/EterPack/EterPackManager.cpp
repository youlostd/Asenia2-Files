...
const char* white_file_list_ext[] = { "xml", "tga", "png", "bmp", "mp3", "jpg", "cfg", "txt", "py", "pyc", "db", "sub", "psd", "pyexec", "rar", "zip", "dds", "msm", "msa" };
...
{
#ifdef URIEL_ANTI_CHEAT
	if (!urielac::AddPackFile((const char*)0xDEADC0DE))
		return false;
#endif
#ifdef __FOX_FS__
