...
namespace UI
{
	...
	class CRenderTarget : public CWindow, public CGraphicBase
	{
		public:
			...
			void SetRenderTargetData(int iRace, int iArmor, int iWeapon, int iHair, int iSash, int iMotionMode);
		...
		protected:
			...
			int m_iRace, m_iArmor, m_iWeapon, m_iHair, m_iSash, m_iMotionMode;
	};
#endif
};
