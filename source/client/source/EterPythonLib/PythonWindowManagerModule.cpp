...
PyObject * wndMgrSetRenderTargetData(PyObject * poSelf, PyObject * poArgs)
{
	...
	int iRace, iArmor, iWeapon, iHair, iSash, iMotionMode;
	...
	if (!PyTuple_GetInteger(poArgs, 5, &iSash))
		return Py_BuildException();
	...
	pRenderWnd->SetRenderTargetData(iRace, iArmor, iWeapon, iHair, iSash, iMotionMode);
	return Py_BuildNone();
}
