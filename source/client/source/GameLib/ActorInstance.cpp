...
{	
	...
	if (!urielac::CheckAttackSpeed(m_fAtkSpd, GetVirtualID()))
		return 1.00f;
#endif
	return m_fAtkSpd;
}
...
{
	if (34036 == m_eRace || 34037 == m_eRace || 34041 == m_eRace || 34042 == m_eRace || 34045 == m_eRace || 34046 == m_eRace || 34049 == m_eRace || 34050 == m_eRace || 34053 == m_eRace || 34054 == m_eRace || 34057 == m_eRace || 34058 == m_eRace || 34061 == m_eRace || 34062 == m_eRace || 34064 == m_eRace || 34065 == m_eRace || 34037 == m_eRace || 34073 == m_eRace || 34074 == m_eRace || 34075 == m_eRace || 34076 == m_eRace || 34080 == m_eRace || 34081 == m_eRace)
		return true;
...
bool CActorInstance::IsMount()
{
	if (m_eRace >= 20110 && m_eRace <= 20299)
		return true;
	else if (m_eRace >= 20475 && m_eRace <= 20490)
		return true;
	return false;
}

bool CActorInstance::IsOfflineShopModel()
{
	if (m_eRace >= 30000 && m_eRace <= 30010)
		return true;
	return false;
}
...
{
#ifdef URIEL_ANTI_CHEAT
	urielac::ClearInstance(GetVirtualID());
#endif
	Destroy();
}
