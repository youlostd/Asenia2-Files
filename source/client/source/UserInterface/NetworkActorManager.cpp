...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_dwCostumEvo = src.m_dwCostumEvo;
#endif
...
CInstanceBase* CNetworkActorManager::__AppendCharacterManagerActor(SNetworkActorData& rkNetActorData)
{
	...
	#ifdef ENABLE_REBIRT_SYSTEM
	kCreateData.m_bRebirt=rkNetActorData.m_bRebirt;
	#endif
...
#endif
#ifdef ENABLE_KOSTUMPARLA
	kCreateData.m_dwCostumEvo = rkNetActorData.m_dwCostumEvo;
#endif
...
void CNetworkActorManager::UpdateActor(const SNetworkUpdateActorData& c_rkNetUpdateActorData)
{
	...
	{
#ifdef ENABLE_KOSTUMPARLA
		pkInstFind->ChangeArmor(c_rkNetUpdateActorData.m_dwArmor, c_rkNetUpdateActorData.m_dwCostumEvo);
		pkInstFind->SetCostumEvo(c_rkNetUpdateActorData.m_dwCostumEvo);
#else
		pkInstFind->ChangeArmor(c_rkNetUpdateActorData.m_dwArmor);
#endif
#ifdef ENABLE_NEW_ARROW_SYSTEM
		pkInstFind->ChangeWeapon(c_rkNetUpdateActorData.m_dwWeapon, c_rkNetUpdateActorData.m_dwArrowType, c_rkNetUpdateActorData.m_dwWeaponEvolution);
#else
		...
		#ifdef ENABLE_REBIRT_SYSTEM
		pkInstFind->SetRebirt(c_rkNetUpdateActorData.m_bRebirt);
		#endif
...
#endif
#ifdef ENABLE_KOSTUMPARLA
	rkNetActorData.m_dwCostumEvo=c_rkNetUpdateActorData.m_dwCostumEvo;
#endif
#ifdef ENABLE_NEW_PET_SYSTEM
	rkNetActorData.m_dwLevel=c_rkNetUpdateActorData.m_dwLevel;
#endif
	...
	#ifdef ENABLE_REBIRT_SYSTEM
	rkNetActorData.m_bRebirt=c_rkNetUpdateActorData.m_bRebirt;
	#endif
#ifdef ENABLE_SKILL_COLOR_SYSTEM
