...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "LWT_BUFF_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "LWT_BUFF_UPDATE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "RADIO_BUTTON_TOOLTIP_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "RADIO_BUTTON_TOOLTIP_UPDATE", 0);
#endif

#ifdef DS_FAST_REFINE
	PyModule_AddIntConstant(poModule, "DS_FAST_REFINE", 1);
#else
	PyModule_AddIntConstant(poModule, "DS_FAST_REFINE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DS_GRADE_EPIC", TRUE);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_GRADE_EPIC", FALSE);
#endif
	...
	PyModule_AddIntConstant(poModule, "PERFORMANCE_FEATURES", 1);
#else
	PyModule_AddIntConstant(poModule, "PERFORMANCE_FEATURES", 0);
#endif
#ifdef ENABLE_REBIRT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_REBIRT_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REBIRT_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_KOSTUMPARLA", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_KOSTUMPARLA", 0);
#endif
...
PyModule_AddIntConstant(poModule, "ENABLE_FOV_OPTION", 0);
#endif
#ifdef OTOMATIK_AV
	PyModule_AddIntConstant(poModule, "OTOMATIK_AV", 1);
#else
	PyModule_AddIntConstant(poModule, "OTOMATIK_AV", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_RENDER_TARGET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENDER_TARGET_SYSTEM", 0);
#endif
...
#ifdef ITEM_SET_BONUS
	PyModule_AddIntConstant(poModule, "ITEM_SET_BONUS", 1);
#else
	PyModule_AddIntConstant(poModule, "ITEM_SET_BONUS", 0);
#endif
