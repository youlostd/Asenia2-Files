...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "AFFECT_KRITIK", CInstanceBase::AFFECT_KRITIK);
	PyModule_AddIntConstant(poModule, "AFFECT_DELICI", CInstanceBase::AFFECT_DELICI);
	PyModule_AddIntConstant(poModule, "AFFECT_E1", CInstanceBase::AFFECT_E1);
	PyModule_AddIntConstant(poModule, "AFFECT_E2", CInstanceBase::AFFECT_E2);
	PyModule_AddIntConstant(poModule, "AFFECT_E3", CInstanceBase::AFFECT_E3);
	PyModule_AddIntConstant(poModule, "AFFECT_E4", CInstanceBase::AFFECT_E4);
	PyModule_AddIntConstant(poModule, "AFFECT_ENERGY", CInstanceBase::AFFECT_ENERGY);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_7", CInstanceBase::AFFECT_POTION_7);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_8", CInstanceBase::AFFECT_POTION_8);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_9", CInstanceBase::AFFECT_POTION_9);
#endif 
#ifdef ENABLE_MELEY_LAIR_DUNGEON
	...
	PyModule_AddIntConstant(poModule, "AFFECT_STATUE5", CInstanceBase::AFFECT_STATUE5);
#endif

	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SHOP_DECO",		CInstanceBase::NEW_AFFECT_SHOP_DECO);
	PyModule_AddIntConstant(poModule, "AFFECT_BUFF_EXTRACT",		CInstanceBase::AFFECT_BUFF_EXTRACT);
	PyModule_AddIntConstant(poModule, "AFFECT_BUFF_EXTRACT_2",		CInstanceBase::AFFECT_BUFF_EXTRACT_2);
	PyModule_AddIntConstant(poModule, "AFFECT_BUFF_EXTRACT_3",		CInstanceBase::AFFECT_BUFF_EXTRACT_3);
	PyModule_AddIntConstant(poModule, "AFFECT_RUZGAR",		CInstanceBase::AFFECT_RUZGAR);
...
#endif
#ifdef OTOMATIK_AV
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_OTO_AV", CInstanceBase::NEW_AFFECT_OTO_AV);
#endif
}
