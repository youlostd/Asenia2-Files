...
void CPythonChat::__Initialize()
{
	...
	m_akD3DXClrChat[CHAT_TYPE_DICE_INFO] = D3DXCOLOR(1.0f, 0.785f, 0.785f, 1.0f);
#if defined(ENABLE_CHATTING_WINDOW_RENEWAL)
...
void CWhisper::Render(float fx, float fy)
{
	...
	RECT Rect = {static_cast<int>(fx), static_cast<int>(fy), static_cast<int>(fx + m_fWidth), static_cast<int>(fy + m_fHeight)};
