...
#ifdef YANG_LIMIT
void CPythonExchange::SetElkToTarget(ULDWORD elk)
{
	m_victim.elk = elk;
}
void CPythonExchange::SetElkToSelf(ULDWORD elk)
{
	m_self.elk = elk;
}

ULDWORD CPythonExchange::GetElkFromTarget()
{
	return m_victim.elk;
}

ULDWORD CPythonExchange::GetElkFromSelf()
{
	return m_self.elk;
}
#else
