...
namespace offlineshop
{
	...
	public:
		...
		void Show(float x, float y, float z) {
			...
			m_thingInstance.RegisterModelThing(0, (CGraphicThing *)CResourceManager::Instance().GetResourcePointer("offlineshop/shop.gr2"));//burda çektirmiş // benim istediği sadece bunu 3000 kodlu npc den çeksin yani şu
