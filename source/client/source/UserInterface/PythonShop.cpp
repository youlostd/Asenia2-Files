...
void CPythonShop::AddPrivateShopItemStock(TItemPos ItemPos, BYTE dwDisplayPos, DWORD dwPrice, DWORD dwPriceCheque, DWORD dwPriceType)
#else
...
void CPythonShop::AddOfflineShopItemStock(TItemPos ItemPos, BYTE dwDisplayPos, DWORD dwPrice, DWORD dwPriceCheque)
...
PyObject * shopAddPrivateShopItemStock(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonShop::Instance().AddPrivateShopItemStock(TItemPos(bItemWindowType, wItemSlotIndex), iDisplaySlotIndex, iPrice, iPriceCheque, iPriceType);
#else
...
PyObject * shopGetItemEvolutionOffline(PyObject * poSelf, PyObject * poArgs)
{
	int iIndex;
	if (!PyTuple_GetInteger(poArgs, 0, &iIndex))
		return Py_BuildException();
...
PyObject * shopGetOfflineShopItemPriceCheque2(PyObject * poSelf, PyObject * poArgs)
{
	BYTE bItemWindowType;
	if (!PyTuple_GetInteger(poArgs, 0, &bItemWindowType))
		return Py_BuildException();
...
void initshop()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetItemEvolutionOffline",	shopGetItemEvolutionOffline,	METH_VARARGS },
...
#ifdef ENABLE_CHEQUE_SYSTEM
		{ "GetOfflineShopItemPriceCheque2",	shopGetOfflineShopItemPriceCheque2,	METH_VARARGS },
#endif
