...
#include "../eterLib/NetDatagramSender.h" // DATAGRAM SENDER
#include "../eterLib/NetDatagramReceiver.h" // DATAGRAM RECEIVER
...
void CServerStateChecker::Request()
{
	...
	udpSender.SetSocket("37.247.99.180", 12308);
	char hello[] = "4rDm5mEMeRtPRxX";
