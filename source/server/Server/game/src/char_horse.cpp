...
DWORD CHARACTER::GetMyHorseVnum()
{
	...
	DWORD horse_looks = GetHorseAppearance();
	
	if (horse_looks > 0 && horse_looks != 20101 && horse_looks != 20104 && horse_looks != 20107)
	{
		return horse_looks;
	}
	
	if(horse_looks == 20101 || horse_looks == 20104 || horse_looks == 20107)
	{
		if (GetGuild())
		{
			horse_looks = horse_looks +1;
