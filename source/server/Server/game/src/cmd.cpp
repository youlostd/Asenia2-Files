...
struct command_info cmd_info[] =
{
	...
	// END_OF_REFINE_PICK
#ifdef KYGN_ITEM_REMOVE_OR_SELL
	{ "add_remove_or_sell_item_index",	do_add_remove_or_sell_item_index,	0,	POS_DEAD,	GM_PLAYER	},
	{ "remove_item_system_button",	do_remove_item_system_button,	0,	POS_DEAD,	GM_PLAYER	},
	{ "remove_or_sell_item_system_close",	do_remove_or_sell_item_system_close,	0,	POS_DEAD,	GM_PLAYER	},
	{ "sell_item_system_button",	do_sell_item_system_button,	0,	POS_DEAD,	GM_PLAYER	},
#endif
	...
	{ "maintenance_text",			do_maintenance_text,			0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "maintenance_update",			do_maintenance_update,			0,			POS_DEAD,	GM_IMPLEMENTOR	},
	...
	{ "dungeontp",	do_dungeontp,	0,	POS_DEAD,	GM_PLAYER	},
	...
	{ "npcisopen",		do_npcac,		0,			POS_DEAD,	GM_PLAYER	},
#endif
#ifdef WJ_SECURITY_SYSTEM
	...
	{ "antiexpac",	do_antiexp_ac,		0,		POS_DEAD,	GM_PLAYER	},
	{ "antiexpkapa",	do_antiexp_kapa,		0,		POS_DEAD,	GM_PLAYER	},
	...
	{ "i_ver1996",			do_i_ver1996,			0,	POS_DEAD,	GM_PLAYER		},
	{ "i_efsun_ver1996",			do_i_efsun_ver1996,			0,	POS_DEAD,	GM_PLAYER		},
...
#endif
#ifdef OTOMATIK_AV
	{ "oto_av", do_otoAv, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_KOSTUMPARLA
	...
	{ "petresetskill", do_ResetPetSkill, 0, POS_DEAD, GM_PLAYER },
#ifdef ENABLE_PET_ATTR_DETERMINE
	...
	//Shop Decoration
	{ "kanal",		do_kanal_switch,		0,			POS_DEAD,	GM_PLAYER	},
	{ "click_safebox",		do_click_safebox,		0,			POS_DEAD,	GM_PLAYER 	},
	{ "stonesell0",		do_stonesell0,		0,			POS_DEAD,	GM_PLAYER	},
	{ "stonesell1",		do_stonesell1,		0,			POS_DEAD,	GM_PLAYER	},
	{ "stonesell2",		do_stonesell2,		0,			POS_DEAD,	GM_PLAYER	},
	{ "stonesell3",		do_stonesell3,		0,			POS_DEAD,	GM_PLAYER	},
	{ "stonesell4",		do_stonesell4,		0,			POS_DEAD,	GM_PLAYER	},
	{ "ds_refinebutton",		do_ds_refbutton,		0,			POS_DEAD,	GM_PLAYER	},
	{ "click_sort_items", 	do_sort_items,  	   0,    POS_DEAD,    GM_PLAYER        },
	{ "k_yenile", 	do_sort_items_with_k,  	   0,    POS_DEAD,    GM_PLAYER        },
#ifdef ENABLE_BATTLE_PASS
	...
	{ "wiki_ac", 	do_wiki,	0,			POS_DEAD,	GM_PLAYER	},	
	{ "ticaret_cam_ac", 	do_ticaret_cam,	0,			POS_DEAD,	GM_PLAYER	},	
#ifdef ENABLE_TITLE_SYSTEM
