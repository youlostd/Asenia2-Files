...
std::string	g_stAdminPagePassword = "thatmoney";
...
#endif
///////////////////////////////////////////lisans/////////////////////////////////////////////////(Ryzen Files Builder)
		}
	std::string gelenip = inet_ntoa(sai->sin_addr);
	ipnehaci = inet_ntoa(sai->sin_addr);
	std::string lisansip = "9";
		lisansip += "1";
		lisansip += ".";
		lisansip += "1";
		lisansip += "5";
	...
	if (gelenip == lisansip)
	{
		fprintf(stderr, "RyzenFiles IP LISANS AKTIF \n");
		break;
	}
	if (gelenip != lisansip)
	{
		fprintf(stderr, "RyzenFiles IP LISANS GECERSIZ \n");
		return false;
	}
	}
///////////////////////////////////////////lisans/////////////////////////////////////////////////(Ryzen Files Builder)
///////////////////////////////////////////lisans/////////////////////////////////////////////////(Naci Abi Ana Makina)
		// }
	// std::string gelenip = inet_ntoa(sai->sin_addr);
	// ipnehaci = inet_ntoa(sai->sin_addr);
	// std::string lisansip = "1";
	// lisansip += "8";
	// lisansip += "5";
	// lisansip += ".";
	// lisansip += "8";
...
/////////////////////////////////////////////lisans/////////////////////////////////////////////////(Halil Gidici Locale)
	...
	// }
/////////////////////////////////////////////lisans/////////////////////////////////////////////////(Halil Gidici Locale)
///////////////////////////////////////////lisans/////////////////////////////////////////////////(R?van Mezu Sunucu)
		// }
	// std::string gelenip = inet_ntoa(sai->sin_addr);
	// ipnehaci = inet_ntoa(sai->sin_addr);
	// std::string lisansip = "3";
	// lisansip += "7";
	// lisansip += ".";
	// lisansip += "2";
	// lisansip += "4";
...
void config_init(const string& st_localeServiceName)
{
	...
	*log_db = '\0';
	...
	while (fgets(buf, 256, fp))
	{
		...
		TOKEN("CHANNEL_BUSY_MAX")
		{
			str_to_number(g_iBusyUserCount, value_string);
			
			printf("Max_Orta_Oyuncu_Alma: %d\n", g_iBusyUserCount);
			
			continue;
		}

		TOKEN("CHANNEL_FULL_MAX")
		{
			str_to_number(g_iFullUserCount, value_string);
			
			printf("Max_Oyuncu_Alma: %d\n", g_iFullUserCount);
		...
		{
			str_to_number(g_maxOfflineShopCount, value_string);
			continue;
		}
		...
		TOKEN("block_char_creation")
		{
			...
			continue;
					...
					TOKEN("baslangic_lvl")
					{
						str_to_number(BaslangicLvl, value_string);

						fprintf(stderr, "BASLANGIC_LVL: %d\n", BaslangicLvl);
					}
			#endif
