...
const int STONE_INFO_MAX_NUM = 2;
...
extern const DWORD		AccSet[6][4];

extern const DWORD		BiyologSistemi[17][16];
extern const char *	Takip[30][3];
...
extern const DWORD		Pet_Skill_Table[25][23];
extern const DWORD		Pet_Table[10][2];
extern const DWORD		Pet_Types[9][3];
#endif

#ifdef ENABLE_REBIRT_SYSTEM
extern const DWORD		exp_rebirt_table[REBIRT_MAX + 11];
#endif
