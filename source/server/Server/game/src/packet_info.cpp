...
#endif
	Set(HEADER_CG_INSTANT_OPEN, sizeof(TInstantChestOpen), "InstantChestOpen", true);
...
CPacketInfoGG::CPacketInfoGG()
{
	...
	Set (HEADER_GG_BOSS_TRACKING,					sizeof (TPacketGGBossTracking),				"BossTracking"				,false); // OK
	#endif
#ifdef ENABLE_SWITCHBOT
