...
enum ESkillFlags
{
	...
	SKILL_FLAG_CRUSH_LONG		= (1 << 23),	// ≫o´e¹æA≫ ¸O¸® ³?¸²
	SKILL_FLAG_PARTY			= (1 << 24),    // Party Flag
	SKILL_FLAG_WIND		= (1 << 25),	// ¹U¶÷ ¼O¼º 
	SKILL_FLAG_ELEC		= (1 << 26),	// Au±a ¼O¼º
...
enum ESkillIndexes
{
	...
	SKILL_HELP_MAHWAN = 242,
	SKILL_HELP_BYEURAK = 243,
#ifdef __WOLFMAN_CHARACTER__
	SKILL_HELP_PASWAE = 244,
#endif
#endif
